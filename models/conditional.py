...
from layers import CondDreamyRNN
...
G_file_path = "./results_autoencoder/G_weights.keras"
E_file_path = "./results_autoencoder/E_weights.keras"
...
def cleanup(data):
  ...
  X = X/127.5 - 1.
  X = X.reshape((sh[0], 4*(time+out_leng), 80, 160, 3))
